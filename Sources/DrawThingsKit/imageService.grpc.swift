...
internal protocol ImageGenerationServiceClientProtocol: GRPCClient {
...
internal final class ImageGenerationServiceClient: ImageGenerationServiceClientProtocol {
  ...
  internal var interceptors: ImageGenerationServiceClientInterceptorFactoryProtocol? {
...
internal struct ImageGenerationServiceNIOClient: ImageGenerationServiceClientProtocol {
...
internal protocol ImageGenerationServiceAsyncClientProtocol: GRPCClient {
...
extension ImageGenerationServiceAsyncClientProtocol {
  ...
  internal func makeGenerateImageCall(
    _ request: ImageGenerationRequest,
    callOptions: CallOptions? = nil
  ) -> GRPCAsyncServerStreamingCall<ImageGenerationRequest, ImageGenerationResponse> {
  ...
  internal func makeFilesExistCall(
    _ request: FileListRequest,
    callOptions: CallOptions? = nil
  ) -> GRPCAsyncUnaryCall<FileListRequest, FileExistenceResponse> {
...
extension ImageGenerationServiceAsyncClientProtocol {
  ...
  internal func uploadFile<RequestStream>(
...
@available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
internal struct ImageGenerationServiceAsyncClient: ImageGenerationServiceAsyncClientProtocol {
  internal var channel: GRPCChannel
  internal var defaultCallOptions: CallOptions
  internal var interceptors: ImageGenerationServiceClientInterceptorFactoryProtocol?
...
internal protocol ImageGenerationServiceClientInterceptorFactoryProtocol: Sendable {
...
internal enum ImageGenerationServiceClientMetadata {
  ...
  internal enum Methods {
    internal static let generateImage = GRPCMethodDescriptor(
      name: "GenerateImage",
      path: "/ImageGenerationService/GenerateImage",
      type: GRPCCallType.serverStreaming
    )

    internal static let filesExist = GRPCMethodDescriptor(
      name: "FilesExist",
      path: "/ImageGenerationService/FilesExist",
      type: GRPCCallType.unary
    )

    internal static let uploadFile = GRPCMethodDescriptor(
      name: "UploadFile",
...
internal protocol ImageGenerationServiceProvider: CallHandlerProvider {
...
@available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *)
internal protocol ImageGenerationServiceAsyncProvider: CallHandlerProvider, Sendable {
  static var serviceDescriptor: GRPCServiceDescriptor { get }
  var interceptors: ImageGenerationServiceServerInterceptorFactoryProtocol? { get }
...
extension ImageGenerationServiceAsyncProvider {
  ...
  internal var interceptors: ImageGenerationServiceServerInterceptorFactoryProtocol? {
    return nil
  }
...
internal protocol ImageGenerationServiceServerInterceptorFactoryProtocol: Sendable {
...
internal enum ImageGenerationServiceServerMetadata {
  internal static let serviceDescriptor = GRPCServiceDescriptor(
    name: "ImageGenerationService",
    fullName: "ImageGenerationService",
    methods: [
